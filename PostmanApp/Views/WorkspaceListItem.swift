...
struct WorkspaceListItem: View {
    ...
    var body: some View {
        HStack {
            ...
            NavigationLink(destination: WorkspaceDetailsView(workspace: workspace, hidePrimaryToolbar: $hidePrimaryToolbar, showNewWorkspaceButton: $showNewWorkspaceButton)) {
...
struct WorkspaceListItem_Previews: PreviewProvider {
    static var previews: some View {
        ...
        WorkspaceListItem(hidePrimaryToolbar: .constant(true), showNewWorkspaceButton: .constant(true), workspace: WorkspaceEntity.example)
